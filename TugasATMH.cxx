...
int main() {
    ...
    float balance = 7000000;
    // Inisialisasi variabel-variabel lain yang dibutuhkan
    int choice, login_attempt = 0;
    int transfer_account_number;
    float transfer_amount, top_up_dana, top_up_gopay, top_up_chip, top_up_token_listrik, withdrawal_amount;
            ...
            while (1) {
                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        printf("3. Top up Chip\n");
                        printf("4. Top up Token Listrik\n");
                        printf("Enter your choice: ");
                        int top_up_choice;
                        ...
                        switch (top_up_choice) {
                            ...
                            case 3:
                                ...
                                printf("Enter PIN: ");
                                scanf("%d", &pin);
                                printf("Top up successful. Your new balance is: %.2f", balance -= top_up_chip);
                                printf("Top up successful. Your new balance is: %.2f\n", balance);
                                 break;
                            case 4:
                                printf("Enter amount to top up: ");
                                scanf("%f", &top_up_token_listrik);
                                printf("Enter PIN: ");
                                scanf("%d", &pin);
                                printf("Top up successful. Your new balance is: %.2f", balance -= top_up_token_listrik);
                                printf("Top up successful. Your new balance is: %.2f\n", balance);
                                break;
                            default:
